...
// import 'package:harsh_minde/Model/Method.dart';
// import 'package:harsh_minde/UI/About.dart';
// import 'package:harsh_minde/UI/FeatureProject.dart';
// import 'package:harsh_minde/UI/Work.dart';
// import 'package:harsh_minde/Widget/AppBarTitle.dart';
// import 'package:harsh_minde/Widget/CustomText.dart';
// import 'package:harsh_minde/Widget/MainTiitle.dart';
// import 'package:harsh_minde/Widget/OSImages.dart';
...
//                               onPressed: () {
//                                 method.launchURL(
//                                     "https://drive.google.com/drive/folders/1HFzq9lhJxTLPF4sgzoZaDMQwYTZB9ZhF");
//                               },
//                               child: Padding(
...
//
// import 'package:flutter/material.dart';
// // import 'package:font_awesome_flutter/font_awesome_flutter.dart';    // done by me --> not working or giving error
// import 'package:harsh_minde/Model/Method.dart';
// import 'package:harsh_minde/UI/About.dart';
// import 'package:harsh_minde/UI/FeatureProject.dart';
// import 'package:harsh_minde/UI/Work.dart';
// import 'package:harsh_minde/Widget/AppBarTitle.dart';
// import 'package:harsh_minde/Widget/CustomText.dart';
// import 'package:harsh_minde/Widget/MainTitle.dart';
// import 'package:harsh_minde/Widget/MainTitle.dart';
// import 'package:harsh_minde/Widget/OSImages.dart';
// // import 'package:scroll_to_index/scroll_to_index.dart' as scroll; // Add the alias as scroll
//
// class HomePage extends StatefulWidget {
//   @override
//   _HomePageState createState() => _HomePageState();
...
// class _HomePageState extends State<HomePage> {
//   Method method = Method();
//   scroll.AutoScrollController _autoScrollController; // Use the alias scroll
//   final scrollDirection = Axis.vertical;
//
//   bool isExpaned = true;
//
...
//   @override
//   void initState() {
//     _autoScrollController = scroll.AutoScrollController( // Use the alias scroll
//       viewportBoundaryGetter: () =>
//           Rect.fromLTRB(0, 0, 0, MediaQuery.of(context).padding.bottom),
//       axis: scrollDirection,
//     )..addListener(
...
//     await _autoScrollController.scrollToIndex(index,
//         preferPosition: scroll.AutoScrollPosition.begin); // Use the alias scroll
//     _autoScrollController.highlight(index);
//   }
//   //
//   // Widget _wrapScrollTag({int index, Widget child}) {
//   //   return scroll.AutoScrollTag( // Use the alias scroll
//   //     key: ValueKey(index),
//   //     controller: _autoScrollController,
//   //     index: index,
//   //     child: child,
...
//
//     IconButton(
//     // icon: FaIcon(FontAwesomeIcons.github),           // Done by mee --> It is not working  --> So changed to belo line
//         icon: Icon(
//           // FontAwesomeIcons.github                      // Done by mee --> It is not working  --> So changed to belo line
//           IconData(0xf09b, fontFamily: 'FontAwesome'), // GitHub icon Unicode
//         ),
//         color: Color(0xffffA8B2D1),
//         iconSize: 16.0,
//     onPressed: () {
...
//
//     IconButton(
//     // icon: FaIcon(FontAwesomeIcons.twitter),            // Done by mee --> It is not working  --> So changed to belo line
//         icon: Icon(
//           // FontAwesomeIcons.twitter                      // Done by mee --> It is not working  --> So changed to belo line
//           IconData(0xf09a, fontFamily: 'FontAwesome'),          // Twitter icon Unicode
//         ),
//     color: Color(0xffffA8B2D1),
//     iconSize: 16.0,
//     onPressed: () {
...
//
//     IconButton(
//     // icon: FaIcon(FontAwesomeIcons.linkedIn),           // Done by mee --> It is not working  --> So changed to belo line
//       icon: Icon(
//         // FontAwesomeIcons.github                      // Done by mee --> It is not working  --> So changed to belo line
//         IconData(0xf08c, fontFamily: 'FontAwesome'), // LinkedIn icon Unicode
//       ),     color: Color(0xffffA8B2D1),
//     onPressed: () {
//     method.launchURL(
//     "www.linkedin.com/in/harsh-minde-268545230");
...
//     ),
//     CustomText(
//     text: "I build things for the Android.",
//     textsize: 56.0,
//     color: Color(0xffCCD6F6).withOpacity(0.6),
//     fontWeight: FontWeight.w700,
//     ),
...
class _HomePageState extends State<HomePage> {
  Method method = Method();
  late ScrollController _autoScrollController; // Use ScrollController
  ...
  Widget build(BuildContext context) {
    ...
    projectDesc:
    "A Mobile app for both Android and IOS. View your Status, Chat, and call history. The purpose of this project is to Learn Flutter complex UI Design.",
    projectTitle: "WhatsaApp UI Clone",
    tech1: "Flutter",
    tech2: "Dart",
    tech3: "Flutter UI",
