    ...
    return Column(
      ...
      children: [
        WorkCustomData(
          ...
          duration: "2016 - Present", key: UniqueKey(), // Provide a unique key
        ),
        WorkCustomData(
          ...
          duration: "Dec - 2019 to Feb - 2020", key: UniqueKey(), // Provide a unique key
        ),
        WorkCustomData(
          title:
          ...
          duration: "Oct - 2019 to Nov - 2020", key: UniqueKey(), // Provide a unique key
        ),
        WorkCustomData(
          ...
          duration: "Sep 2020 - Oct 2020", key: UniqueKey(), // Provide a unique key
        ),
        WorkCustomData(
          ...
          duration: "Nov - 2020 Present", key: UniqueKey(), // Provide a unique key
        ),
      ],
    );
  }
