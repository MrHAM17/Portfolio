...
class _AppHomeState extends State<AppHome> {
  final ScrollController _scrollController = ScrollController();       // -------- ------- -------- >>>>>>>>>>> part of way 1  (when click on masksTheater icon) ----->> IMP
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          controller: _scrollController,     // -------- ------- -------- >>>>>>>>>>> part of way 1 (when click on masksTheater icon)----->> IMP
          child: Padding(
