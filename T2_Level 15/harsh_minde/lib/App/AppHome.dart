  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        // backgroundColor: widget.color.gradient!.colors.first,  // works but not accurately
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  //  // Image  ------- ---  ==>>>  Below is custom code --> of bg frame of profile pic --> for app view  ( help to --> No animation like web view )
                  // Center(
                  //   child: Container(
                ...
                //  // Experience  ------- ---  ==>>>  Below is custom code --> of experience --> for app view  ( help to --> represent experience part not like web view(using card) )
...
//  // Animation  ------- ---  ==>>>  Below is custom code --> of simple animataion (hover --> color change) for profile pic --> for app view  ( help to --> No Animation like web view )
